    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
					<form class="needs-validation" method="post" action="{{ route('contact_update', ['contact'=>$contact_id]) }}" novalidate>
						@csrf
						<div class="form-row">
							<div class="col">
						...
						<button class="btn btn-primary" type="submit">{{ trans('contact.change') }}</button>
					</form>
                </div>
